...
class EmpresaService {
    ...
    async listar (conexao: any, empresa: Empresa, pagina: number, res: Response): Promise<any> {
    ...
    async novo (conexao: any, empresa: Empresa, res: Response): Promise<any> {
        const empresaPersistence: EmpresaPersistence = new EmpresaPersistence(conexao)
        const resultado: ObjetoResultado = new ObjetoResultado()
        try {
    ...
    async atualizar (conexao: any, empresa: Empresa, res: Response): Promise<any> {
        const empresaPersistence: EmpresaPersistence = new EmpresaPersistence(conexao)
        const resultado: ObjetoResultado = new ObjetoResultado()
        try {
